    ...
    private static void wrapImageTransform(final RoutingContext routingContext) {
        ...
        try {
            switch (transformation) {
                case "shiftLeft":
                    transformedPixels = Transform.shiftLeft(pixels0,
                            Transform.DEFAULT_POSITION_SHIFT);
                    break;
                case "shiftRight":
                    transformedPixels = Transform.shiftRight(pixels0,
                            Transform.DEFAULT_POSITION_SHIFT);
                    break;
                case "shiftUp":
                    transformedPixels = Transform.shiftUp(pixels0,
                            Transform.DEFAULT_POSITION_SHIFT);
                    break;
                case "shiftDown":
                    transformedPixels = Transform.shiftDown(pixels0,
                            Transform.DEFAULT_POSITION_SHIFT);
                    break;
                case "rotateLeft":
                ...
                case "expandHorizontal":
                    ...
                    break;
                case "moreRed":
                    transformedPixels = Transform.moreRed(pixels0,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "lessRed":
                    transformedPixels = Transform.lessRed(pixels0,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "moreGreen":
                    transformedPixels = Transform.moreGreen(pixels0,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "lessGreen":
                    transformedPixels = Transform.lessGreen(pixels0,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "moreBlue":
                ...
                case "greenScreen":
                    ...
                    break;
                case "mystery":
                    transformedPixels = Transform.mystery(pixels0);
                    break;
                default:
